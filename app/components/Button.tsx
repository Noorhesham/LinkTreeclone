...
const Button = ({
  ...
  return (
    <button
      disabled={disabled}
      onClick={onClick}
      className={`relative min-w-[150px] inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 ${
        className || ""
      }`}
    >
